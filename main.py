...
# ==========================================
# دالة إرسال الملفات - تصليح الأخطاء
# ==========================================
...
def universal_handler(message):
    ...
    # التعامل مع المجلدات الديناميكية (📁)
    ...
    # استرجاع الملفات عند الضغط على زر ملف (مع معالجة المسافات المخفية)
