...
# 🚀 تم تثبيت رابط قاعدة بيانات Supabase الخاصة بك بنجاح هنا
DATABASE_URL = "postgresql://postgres:alwatheq734@db.jknojabyblhpoudaowzr.supabase.co:5432/postgres"

bot = telebot.TeleBot(API_TOKEN)
app = Flask(__name__)

# --- مجمع اتصالات آمن لمنع التضارب عند الرفع المتعدد ---
try:
...
# --- نظام إنشاء الجداول تلقائياً في Supabase مع الإيموجيات الرسمية للمواد ---
def init_db():
